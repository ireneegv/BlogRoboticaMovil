...
Mi error principal en el código anterior es que al meter un bucle while bloqueante dentro de una máquina de estados reactiva ya que el robot se queda atrapado haciendo la espiral y no lee la informacion del bumper. En este nuevo código la espiral se calcula de manera iterativa en cada ciclo del bucle en el estado FORWARD. También cambie el calculo de la espiral a la ecuacion matematica de la espiral de Arquimedes y incremente el tiempo del estado FORWARD a 30 segundos. 
